import { G, BOATS } from './shared.js';
import { RODS, UPGRADES, FISH, ACHIEVEMENTS, getCompletion, rarityColor } from './fishing.js';
...
function drawRace(c, w, h) {
  ...
  if (G.state === 'RESULTS') drawResults(c, w, h, entries);
}
